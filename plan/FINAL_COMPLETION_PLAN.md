...
- **Corrective Gate Status:** `FIXED` — 51/51 regression tests pass bằng Python 3.13; UI tự tính đủ history cho mọi test point và cấm fallback dynamic alpha trong backtest; TASK-08 benchmark vẫn chưa chạy lại.
- **Priority:** `P0` / `P1`
