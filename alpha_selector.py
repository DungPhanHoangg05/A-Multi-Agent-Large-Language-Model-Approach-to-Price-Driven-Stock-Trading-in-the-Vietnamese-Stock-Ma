...
from alpha_compare import ALPHA_REGISTRY, load_data, run_backtest, rank_alphas

def select_top_alphas(symbol: str, interval: str = "1d", top_n: int = 5) -> List[Dict[str, Any]]:
    """
