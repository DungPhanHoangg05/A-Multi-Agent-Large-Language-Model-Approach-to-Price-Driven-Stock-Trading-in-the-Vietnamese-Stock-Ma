...
MESSAGES["vi"] = {
    ...
    "bt_chart_pnl":             "Giá trị tài khoản BUY/HOLD/SELL (VND)",
    ...
    "bt_th_full_return":        "Đầy đủ: kỳ / lũy kế",
    "bt_th_no_pred":            "Dự đoán Không α",
    "bt_th_no_ok":              "Không α ✓",
    "bt_th_no_return":          "Không α: kỳ / lũy kế",
    ...
    "bt_hold_long":             "đã có cổ phiếu, tiếp tục nắm giữ",
    "bt_cash_no_position":      "chưa có cổ phiếu, giữ tiền mặt",
...
MESSAGES["en"] = {
    ...
    "bt_chart_pnl":             "BUY/HOLD/SELL account value (VND)",
    ...
    "bt_th_full_ok":            "Full ✓",
    "bt_th_full_return":        "Full: period / cumulative",
    "bt_th_no_pred":            "No-α pred",
    "bt_th_no_ok":              "No-α ✓",
    "bt_th_no_return":          "No-α: period / cumulative",
    ...
    "bt_hold_long":             "already invested, keep holding",
    "bt_cash_no_position":      "no shares held, keep cash",
