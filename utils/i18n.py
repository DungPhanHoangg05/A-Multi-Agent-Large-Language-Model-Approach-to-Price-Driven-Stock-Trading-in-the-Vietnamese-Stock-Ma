...
MESSAGES["vi"] = {
    ...
    "bt_pnl_sub":               "Lãi kép lũy kế; chi tiết lãi/lỗ từng kỳ ở bảng dưới",
    ...
    "bt_th_window":             "Cửa sổ",
    "bt_th_actual":             "Nhãn C→C",
    "bt_th_execution":          "Giá thực thi O→C",
    ...
    "bt_test":                  "Lần",
    "bt_actual":                "Nhãn hướng C→C",
    "bt_execution":             "Thực thi O→C",
    "bt_period":                "Kỳ",
    "bt_cumulative":            "Lũy kế",
    "bt_skip_overlap":          "bỏ qua vì vốn đang khóa",
    "bt_skip_short":            "SHORT giữ tiền mặt",
...
MESSAGES["en"] = {
    ...
    "bt_pnl_no":                "No-α P&L",
    "bt_pnl_sub":               "Compounded cumulative return; per-period P&L is shown below",
    ...
    "bt_th_window":             "Window",
    "bt_th_actual":             "C→C label",
    "bt_th_execution":          "Execution O→C",
    ...
    "bt_test":                  "Test",
    "bt_actual":                "Direction label C→C",
    "bt_execution":             "Execution O→C",
    "bt_period":                "Period",
    "bt_cumulative":            "Cumulative",
    "bt_skip_overlap":          "skipped while capital is locked",
    "bt_skip_short":            "SHORT holds cash",
