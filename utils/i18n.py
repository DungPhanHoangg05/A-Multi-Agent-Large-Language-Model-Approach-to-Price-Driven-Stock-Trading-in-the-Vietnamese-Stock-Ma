...
MESSAGES["vi"] = {
    ...
    "bt_step_hint":             "Khung ngày yêu cầu ≥3 để các kỳ không chồng lấn",
    ...
    "bt_pnl_sub":               "Vốn ban đầu 50.000.000 ₫ · đang chờ giao dịch",
    "bt_chart_pnl":             "Giá trị tài khoản theo chu kỳ BUY→SELL (VND)",
    "bt_chart_acc":             "Độ chính xác kinh tế lũy tiến",
    "bt_chart_x":               "Lần kiểm định #",
    "bt_chart_y_pnl":           "Giá trị tài khoản (VND)",
    ...
    "bt_compare_sub":           "Đúng/sai theo net return Open→Close sau phí hai chiều",
    "bt_no_data":               "Chưa có dữ liệu",
    "bt_timeline":              "Chi tiết từng điểm kiểm định",
    "bt_th_window":             "Cửa sổ",
    "bt_th_actual":             "Nhãn net O→C",
    "bt_th_execution":          "Thực thi O→C (gross)",
    "bt_th_full_pred":          "Dự đoán Đầy đủ",
    "bt_th_full_ok":            "Đầy đủ ✓",
    "bt_th_full_return":        "Đầy đủ: chu kỳ / lũy kế",
    "bt_th_no_pred":            "Dự đoán Không α",
    "bt_th_no_ok":              "Không α ✓",
    "bt_th_no_return":          "Không α: chu kỳ / lũy kế",
    ...
    "bt_test":                  "Lần",
    "bt_actual":                "Nhãn net O→C sau phí",
    "bt_execution":             "Thực thi O→C",
    "bt_period":                "Chu kỳ",
    "bt_cumulative":            "Lũy kế",
    "bt_cash":                  "Tiền mặt",
    "bt_action":                "Hành động",
    "bt_initial_capital":       "Vốn ban đầu",
    "bt_shares":                "CP",
    "bt_equity":                "Tài sản",
    "bt_fee":                   "Phí MG mua+bán",
    "bt_slippage":              "Trượt giá",
    "bt_trade_round_trip":      "mua tại Open, bán tại Close mục tiêu",
    "bt_cash_short":            "SHORT: giữ tiền mặt suốt horizon",
    "bt_decision_fallback":     "Fallback an toàn",
    "bt_skip_invalid":          "dự đoán không hợp lệ",
    "bt_acc_total":             "Độ chính xác kinh tế",
...
MESSAGES["en"] = {
    ...
    "bt_step_hint":             "Daily backtests require ≥3 to avoid overlapping periods",
    ...
    "bt_pnl_no":                "No-α P&L",
    "bt_pnl_sub":               "Initial capital VND 50,000,000 · waiting for trades",
    "bt_chart_pnl":             "Fixed-horizon BUY→SELL account value (VND)",
    "bt_chart_acc":             "Cumulative economic accuracy",
    "bt_chart_x":               "Test #",
    "bt_chart_y_pnl":           "Account value (VND)",
    "bt_ds_full_pnl":           "Full (α)",
    "bt_ds_no_pnl":             "No-α",
    "bt_ds_full_correct":       "Full correct",
    "bt_ds_no_correct":         "No-α correct",
    "bt_compare":               "Detailed comparison",
    "bt_compare_sub":           "Correctness by net Open→Close return after both-side costs",
    "bt_no_data":               "No data yet",
    "bt_timeline":              "Per-test-point details",
    "bt_th_window":             "Window",
    "bt_th_actual":             "Net O→C label",
    "bt_th_execution":          "Execution O→C (gross)",
    "bt_th_full_pred":          "Full pred",
    "bt_th_full_ok":            "Full ✓",
    "bt_th_full_return":        "Full: cycle / cumulative",
    "bt_th_no_pred":            "No-α pred",
    "bt_th_no_ok":              "No-α ✓",
    "bt_th_no_return":          "No-α: cycle / cumulative",
    ...
    "bt_test":                  "Test",
    "bt_actual":                "Net O→C label after costs",
    "bt_execution":             "Execution O→C",
    "bt_period":                "Cycle",
    ...
    "bt_shares":                "Shares",
    "bt_equity":                "Equity",
    "bt_fee":                   "Buy+sell broker fees",
    "bt_slippage":              "Slippage",
    "bt_trade_round_trip":      "buy at Open, sell at target Close",
    "bt_cash_short":            "SHORT: keep cash for the horizon",
    "bt_decision_fallback":     "Safe fallback",
    "bt_skip_invalid":          "invalid prediction",
    "bt_acc_total":             "Economic accuracy",
